...
const NSUInteger kQMApplicationID = 42541;
NSString *const kQMAuthorizationKey = @"v6Rx-anynnBJWXE";
NSString *const kQMAuthorizationSecret = @"WJzbOXwQnV-unMM";
NSString *const kQMAccountKey = @"xsqz1wp34TpVqyfpRUXT";
#endif
